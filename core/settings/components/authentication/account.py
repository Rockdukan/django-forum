# Поля при регистрации: * = обязательное. При ACCOUNT_EMAIL_VERIFICATION = 'mandatory' нужен email*
...
# Способы входа: username и/или email (новая замена ACCOUNT_AUTHENTICATION_METHOD)
...
# В проекте предполагается один адрес: он же основной.
...
# Обязательность username задаётся через ACCOUNT_SIGNUP_FIELDS (username*)
